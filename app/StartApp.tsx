          ...
          {expanded && <div id={`stage-editor-${stage.id}`} className="stage-editor-body">
            ...
            <div className="stage-main">
              ...
              <div className="stage-meta">
                <button className={`effort-pill effort-${stage.kind === "rest" ? "rest" : stage.effort}`} onClick={() => { setEditingStageId(stage.id); go("effort"); }}>{stage.kind === "rest" ? "休息放松" : effortCopy[stage.effort]} · 调整</button>
